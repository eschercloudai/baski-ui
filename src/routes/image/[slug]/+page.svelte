<script>
    import {downIcon, failed_colour, failed_icon, good_colour, good_icon, upIcon} from "$lib/common.js";
    ...
    <div class="md:grid md:grid-cols-12 col-span-10">
        <div class="col-span-6 order-1 mx-0 mb-2 md:order-0 md:mx-2 md:mb-0">
            <div class="text-white h-24 pt-8" style="background-color: var(--brand)">
                <h3 class="text-2xl text-center font-semibold leading-7">Vulnerability
                    Information</h3>
        ...
        <div class="col-span-6 order-0 mx-0 mb-2 md:order-1 md:mx-2 md:mb-0">
            <div class="text-white h-24 pt-8 grid justify-items-center" style="background-color: var(--brand)">
                <div>
